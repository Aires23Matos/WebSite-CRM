    ...
    try {
      ...
      const mockActivities = [
        ...
        },
        {
          ...
          type: "client",
          action: "updated",
          name: "Dados do cliente modificados",
          time: "2 dias atrás",
        },
      ];
      ...
      <Grid container spacing={3} mb={4}>
        ...
        <Grid item xs={12} sm={6} lg={3}>
          <StatCard
            ...
            progress={
              (stats.activeLicenses / Math.max(stats.totalClients, 1)) * 100
            }
          />
        </Grid>
        ...
        <Grid item xs={12} sm={6} lg={3}>
          <StatCard
            ...
            progress={
              (stats.expiringLicenses / Math.max(stats.activeLicenses, 1)) * 100
            }
          />
        </Grid>
      </Grid>
